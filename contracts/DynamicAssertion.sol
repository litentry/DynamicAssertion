...
abstract contract DynamicAssertion {
	...
	) internal returns (string memory returnVal) {
	...
	function has_polygon_network(
		Identity memory identity_type
	) internal pure returns (bool) {
		return has_network(identity_type, 14);
	}

	function has_arbitrum_network(
		Identity memory identity_type
	) internal pure returns (bool) {
		return has_network(identity_type, 15);
	}

	function has_solana_network(
		Identity memory identity_type
	) internal pure returns (bool) {
